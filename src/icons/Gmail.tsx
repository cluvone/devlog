export default function Gmail(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
      <g>
        <g>
          <g>
            <g>
              <rect height="358.87" width="357.904" x="77.045" y="76.565" fill="rgb(241, 245, 247)" />
              <path d="M256.002,293.738l178.947,141.697v-279.74L256.002,293.738z M256.002,293.738" fill="rgb(220, 230, 234)" />
              <path
